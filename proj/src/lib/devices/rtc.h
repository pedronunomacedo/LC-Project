...
unsigned (rtc_get_year)(void);

unsigned (rtc_get_month)(void);

unsigned (rtc_get_day)(void);

unsigned (rtc_get_hour)(void);

unsigned (rtc_get_minute)(void);

unsigned (rtc_get_second)(void);
